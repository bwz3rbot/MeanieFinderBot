...
const runOnceIndefinately = function () {
    if (logging) {
        console.log(('NUMBER OF ITEMS IN THE QUEUE: ' + newItems.length).yellow)
    }
    ...
    if (newItems[0] != undefined) {
        ...
        if (logging) {
            ...
            console.log(formattedDate + `|  there are no items left in the queue! checking again in ${timeout/1000} seconds...`.red)
        }
